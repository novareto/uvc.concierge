            ...
            handshake_reply +=  (
                ...
                "Sec-WebSocket-Accept: %s\r\n\r\n"
                 % (environ.get('HTTP_ORIGIN'),
                    ...
                    ws.path,
                    version,
                    base64.b64encode(sha1(key + WS_KEY).digest()).decode('utf-8'))
                )
...
class WebSocket(object):
        ...
        while buf:
            if self.version in ['7', '8', '13']:
                ...
                if frame_type == 0:
                    ...
                    raise ValueError(
                        "Don't understand how to parse this type of "
                        "message: %r" % buf)
        self._buf = buf
        return msgs
    ...
    def send(self, message):
        ...
        *message* should be convertable to a string; unicode objects should be
        ...
        if self.version in ['7', '8', '13']:
            packed, lenhead, lentail = self.encode_hybi(
                s2b(message), opcode=0x01, base64=False)
        else:
